...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_Insert.setGeometry(QtCore.QRect(30, 170, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_insert2.setText(_translate("MainWindow", "Insert a State"))
        self.label_Insert.setText(_translate("MainWindow", "Insert a Product"))
        self.label_TituPrev.setText(_translate("MainWindow", "States Forecast"))

        # ================================================AAAAAAAAA========================================================
        self.btn_prediction.setText(_translate("MainWindow", "Prediction"))
        self.btn_prediction.clicked.connect(self.preverCalculo)

        self.btn_calculate.setText(_translate("MainWindow", "Calculate the Log"))
        self.btn_calculate.clicked.connect(self.calcular)
        # ========================================================================================================
        self.label_calcu.setText(_translate("MainWindow", "Calculate the Log"))
        self.label_file.setText(_translate("MainWindow", "Show Open File"))
        # ==============================================AAAAAA==========================================================
        self.btn_mostrarDados.setText(_translate("MainWindow", "Show Data"))
        self.btn_mostrarDados.clicked.connect(self.get_text_file)
        # ========================================================================================================
        self.label_log.setText(_translate("MainWindow", "Show Dates Log"))
        # ==============================================AAAAAA==========================================================
        self.btn_mostrarLog.setText(_translate("MainWindow", "Show Data"))
        self.btn_mostrarLog.clicked.connect(self.get_table_Log)
        # ========================================================================================================
        self.label_export.setText(_translate("MainWindow", "Export Excel"))
        # ==============================================AAAAAA==========================================================
        self.btn_runExport.setText(_translate("MainWindow", "Run Export"))
    ...
    def save_ex(self):
        try:
            ...
            msg = QMessageBox()
            msg.setWindowTitle("Save Excel")
            msg.setText("aaaaaaaaaaaaaaaaaaaaaaa")
            msg.setIcon(QMessageBox.Critical)
            msg.exec_()
        ...
        while LoopPreviEx:
            ...
            while Looptxt:
                if len(listas) == 0:
                    ...
                    msg.setWindowTitle("Export Erro")
                    msg.setText(
                        "O dicionário inserido está vazio!! Insira outro ou tente carregar os dados na opção do Menu!!!")
                    msg.setIcon(QMessageBox.Critical)
                    msg.exec_()
